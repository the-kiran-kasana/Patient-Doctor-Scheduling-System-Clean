...
import { Cog , MessageSquare , CalendarDays ,LayoutDashboard , CalendarCheck, Clock, User, Loader2 , BookX , ClipboardClock, CalendarDays} from "lucide-react";
     ...
     <h2 className=" p-6 font-bold text-2xl text-center text-blue-800"> Upcoming Appointment </h2>
      ...
      <aside className="w-[380px] p-10 space-y-6">
        ...
        <div className="bg-white shadow-md rounded-xl p-4">
              <h2 className="font-bold text-lg text-blue-900 mb-3"><CalendarDays />Total Appointments</h2>
              <h2 className="font-bold text-lg text-blue-900 mb-3"><ClipboardClock />Pending Appointments</h2>
        ...
        <div className="bg-white shadow-md rounded-xl p-4">
                      <h2 className="font-bold text-lg text-blue-900 mb-3"><CalendarCheck />Completed Appointments</h2>
...
<div className="bg-white shadow-md rounded-xl p-4">
  <h2 className="font-bold text-lg text-blue-900 mb-3 flex items-center gap-2">
    <BookX size={30} className="text-blue-800" /> <span>Cancelled Appointments</span>
  </h2>
